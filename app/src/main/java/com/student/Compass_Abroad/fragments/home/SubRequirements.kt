...
import com.student.Compass_Abroad.databinding.FragmentSubRequirementsBinding
...
class SubRequirements : BaseFragment() {

    private lateinit var binding: FragmentSubRequirementsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSubRequirementsBinding.inflate(inflater, container, false)
            ...
            clientEventModal?.let { nonNullForgetModal ->
                if (clientEventModal.statusCode == 200) {
                    ...
                    if (applicationProgram != null) {
                        binding.tv.text = applicationProgram.get(0)?.program?.min_requirement
                            ?: "No requirement specified"
                    } else {
                        // Handle case where `data` is null
                        binding.tv.text = "No data available"
