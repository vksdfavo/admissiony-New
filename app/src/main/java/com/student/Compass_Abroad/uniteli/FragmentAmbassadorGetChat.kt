...
import com.student.Compass_Abroad.databinding.FragmentAmbassadorGetChatBinding
...
import com.student.Compass_Abroad.uniteli.adapter.AmbassadorAdapterDetailConversation
...
class FragmentAmbassadorGetChat : BaseFragment() {
    private lateinit var binding: FragmentAmbassadorGetChatBinding
    private lateinit var adapterApplicationDetailConversation: AmbassadorAdapterDetailConversation
    private var chatRecords =
        mutableListOf<com.student.Compass_Abroad.modal.ambassadorGetChat.Record>()
    ...
    private lateinit var viewModel: AmbassadorChatViewModel
    ...
    override fun onCreateView(
        ...
        binding = FragmentAmbassadorGetChatBinding.inflate(inflater, container, false)
        chatIdentifier = App.singleton?.relationIdentifier
        ...
        status = arguments?.getString("relation_identifier")!!

        status = App.singleton?.relationIdentifier.toString()


        Log.d("onCreateView", status)
        ...
        binding.sendBtn.setOnClickListener {
            ...
            if (chatMessage.isEmpty()) {
                ...
                postChatMessage(chatMessage.trim(), status)
            }
    ...
    private fun postChatMessage(
        ...
        CommonUtils.accessToken?.let { accessToken ->
            ...
            viewModel.addConversationAmbassadorLiveData(
                requireActivity(),
    ...
    private fun openBottomSheetDocument() {
        ...
        bottomSheetDialog = BottomSheetDialog(requireActivity(), R.style.BottomSheet2).apply {
            ...
            bottomSheetBinding.llBsUdUseCamera.setOnClickListener {
                ImagePicker.with(this@FragmentAmbassadorGetChat)
                    .cameraOnly()
                    .compress(1024)
    ...
    private fun setupChatAdapter() {
        viewModel = ViewModelProvider(this)[AmbassadorChatViewModel::class.java]
        adapterApplicationDetailConversation =
            AmbassadorAdapterDetailConversation(requireActivity(), chatRecords)
    ...
    private fun appendNewMessages(newMessages: List<com.student.Compass_Abroad.modal.ambassadorGetChat.Record>) {
    ...
    private fun fetchChatMessagesAndMetaData() {
        ...
        App.singleton?.relationIdentifier?.let {
            viewModel.getChatResponseLiveData(
                ...
                "desc"
            ).observe(viewLifecycleOwner) { getChatResponse: AmbassadorGetChatData? ->
                isLoading = false
