...
class AttendanceAdapter(
    private val attendanceList: List<com.student.Compass_Abroad.modal.getProgramFilters.AttendanceOn>,
    private val onItemClick: (com.student.Compass_Abroad.modal.getProgramFilters.AttendanceOn) -> Unit
    ...
    inner class AttendanceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(attendance: com.student.Compass_Abroad.modal.getProgramFilters.AttendanceOn) {
