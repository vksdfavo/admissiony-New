...
class AdapterGetIntakeList(var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.intakeModel.Data>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.intakeModel.Data? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.intakeModel.Data) -> Unit)? = null
