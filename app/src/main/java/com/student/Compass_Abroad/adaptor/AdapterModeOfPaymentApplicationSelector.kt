...
class AdapterModeOfPaymentApplicationSelector (var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.getPaymentMode.Record>, var popupBinding: View) : RecyclerView.Adapter<AdapterModeOfPaymentApplicationSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem:com.student.Compass_Abroad.modal.getPaymentMode.Record? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.getPaymentMode.Record) -> Unit)? = null
    ...
    override fun onBindViewHolder(
        ...
        holder.binding.tvItemCountrySelector.text = item.name
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.getPaymentMode.Record>
            notifyDataSetChanged()
