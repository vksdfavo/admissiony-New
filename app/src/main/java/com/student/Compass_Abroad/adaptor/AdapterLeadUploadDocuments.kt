...
class AdapterLeadUploadDocuments(var context: Context,var  files: ArrayList<File>):RecyclerView.Adapter<AdapterUploadDocuments.MyViewHolder>(){
...
//        parent: ViewGroup,
//        viewType: Int,
//    ): AdapterUploadDocuments.MyViewHolder {
//        val binding = ItemUploadDcumentsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
//        return AdapterUploadDocuments.MyViewHolder(binding)
//    }
//
//
//
//    override fun onBindViewHolder(holder: AdapterUploadDocuments.MyViewHolder, position: Int) {
