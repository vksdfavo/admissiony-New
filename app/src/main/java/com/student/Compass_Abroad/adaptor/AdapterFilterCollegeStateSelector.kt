...
class AdapterFilterCollegeStateSelector(
    private val requireActivity: FragmentActivity,
    private val arraylist: ArrayList<com.student.Compass_Abroad.modal.stateModel.Data>,
    private val popupBinding: View
) : RecyclerView.Adapter<AdapterFilterCollegeStateSelector.MyViewHolder>() {

    private var filteredList: MutableList<com.student.Compass_Abroad.modal.stateModel.Data> = arraylist.toMutableList() // Maintain filtered list
    private var selectedItem: com.student.Compass_Abroad.modal.stateModel.Data? = null // Store only one selected item

    var onItemClickListener: ((com.student.Compass_Abroad.modal.stateModel.Data?) -> Unit)? = null
    ...
    fun getSelectedItem(): com.student.Compass_Abroad.modal.stateModel.Data? {
        return selectedItem
    }

    fun setInitialSelection(selectedItem: com.student.Compass_Abroad.modal.stateModel.Data?) {
    ...
    inner class MyViewHolder(private val binding: ItemCustomPopupCountrySelectorBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: com.student.Compass_Abroad.modal.stateModel.Data) {
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.stateModel.Data>
            notifyDataSetChanged()
