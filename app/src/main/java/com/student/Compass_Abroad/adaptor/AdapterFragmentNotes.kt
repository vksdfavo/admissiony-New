...
import com.student.Compass_Abroad.databinding.ItemNotesBinding
import com.student.Compass_Abroad.encrytion.decryptData
import com.student.Compass_Abroad.modal.getApplicationNotes.Record

class AdapterFragmentNotes(var context: Context?,
                               var applicationNotesList: MutableList<Record>):
    RecyclerView.Adapter<AdapterFragmentNotes.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var record=applicationNotesList[position]

        holder.bind(record,context)
    }

    override fun getItemCount(): Int {
        return applicationNotesList.size
    }

    class MyViewHolder(var binding: ItemNotesBinding) : RecyclerView.ViewHolder(binding.getRoot()) {
