...
class AdapterFilterIntakeSelector (
    var requireActivity: FragmentActivity,
    var arraylist: ArrayList<com.student.Compass_Abroad.modal.intakeModel.Data>,
    var popupBinding: View,


    ) : RecyclerView.Adapter<AdapterFilterIntakeSelector.MyViewHolder>() {

    private var filteredList :MutableList<com.student.Compass_Abroad.modal.intakeModel.Data> =arraylist.toMutableList() // Maintain filtered list
    private var selectedItems: MutableList<com.student.Compass_Abroad.modal.intakeModel.Data> = mutableListOf()

    var onItemClickListener:((List<com.student.Compass_Abroad.modal.intakeModel.Data>) -> Unit)? = null
    ...
    fun getSelectedItems(): List<com.student.Compass_Abroad.modal.intakeModel.Data> {
        return selectedItems
    }

    fun setInitialSelection(selectedItems: List<com.student.Compass_Abroad.modal.intakeModel.Data>) {
    ...
    inner class MyViewHolder(private val binding: ItemCustomPopupCountrySelectorBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item:com.student.Compass_Abroad.modal.intakeModel.Data) {
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.intakeModel.Data>
            notifyDataSetChanged()
            ...
            if (filteredList.isEmpty()) {
                ...
                popupBinding.requireViewById<TextView>(R.id.tvSelect_noData).text = "No Intake   Found"
            } else {
