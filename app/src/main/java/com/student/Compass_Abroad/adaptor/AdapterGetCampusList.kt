...
class AdapterGetCampusList(var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.GetCampusModal.Data>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.GetCampusModal.Data? = null
