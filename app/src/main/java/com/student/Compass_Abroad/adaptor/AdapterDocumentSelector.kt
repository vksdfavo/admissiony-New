...
class AdapterDocumentSelector(var requireActivity: FragmentActivity, var arraylist: ArrayList<com.student.Compass_Abroad.modal.getDocumentTypes.RecordsInfo>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.getDocumentTypes.RecordsInfo? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.getDocumentTypes.RecordsInfo) -> Unit)? = null
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.getDocumentTypes.RecordsInfo>
            notifyDataSetChanged()
