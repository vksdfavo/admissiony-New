...
class AdapterDestinationCountrySelector(var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.getDestinationCountryList.Data>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.getDestinationCountryList.Data? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.getDestinationCountryList.Data) -> Unit)? = null
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.getDestinationCountryList.Data>
            notifyDataSetChanged()
