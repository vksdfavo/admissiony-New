...
class AdapterCountryList(var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.GetStudentsModal.Data>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.GetStudentsModal.Data? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.GetStudentsModal.Data) -> Unit)? = null
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.GetStudentsModal.Data>
            notifyDataSetChanged()
