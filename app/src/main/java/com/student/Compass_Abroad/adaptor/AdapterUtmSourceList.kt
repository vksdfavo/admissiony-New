...
class AdapterUtmSourceList(var requireActivity: FragmentActivity, var arraylist: MutableList<RecordsInfo>, var popupBinding: View, ) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {
