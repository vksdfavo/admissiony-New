...
class AdapterPaymentForApplicationSelector(var requireActivity: FragmentActivity, var arraylist: MutableList<com.student.Compass_Abroad.modal.getPaymentForDropDown.RecordsInfo>, var popupBinding: View) : RecyclerView.Adapter<AdapterFilterTestScoreSelector.MyViewHolder>() {

    private var filteredList = arraylist.toMutableList()
    private var selectedItem: com.student.Compass_Abroad.modal.getPaymentForDropDown.RecordsInfo? = null

    var onItemClickListener: ((com.student.Compass_Abroad.modal.getPaymentForDropDown.RecordsInfo) -> Unit)? = null
    ...
    private val exampleFilter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            filteredList = results?.values as MutableList<com.student.Compass_Abroad.modal.getPaymentForDropDown.RecordsInfo>
            notifyDataSetChanged()
